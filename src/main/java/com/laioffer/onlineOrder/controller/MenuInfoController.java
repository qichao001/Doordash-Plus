...
public class MenuInfoController {
    ...
    public  List<MenuItem> getMenus(@PathVariable("restaurantId") int restaurantId) {
        return menuInfoService.getMenuItems(restaurantId);
    }
...
//    public List<MenuItem> getMenus(@PathVariable("restaurantId") int restaurantId, @PathVariable("menuId") int menuId) {
//    }
}
